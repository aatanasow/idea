    ...
    <div class="py-8 max-w-4xl mx-auto">
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="gap-x-2 items-center flex">
                <button class="btn btn-outlined" data-test="edit-idea-button" id="btn">
                    <x-icons.external />
                    Edit
                </button>
                ...
                <form action="{{ route('idea.destroy', $idea) }}" method="post">
                    ...
                    <button class="btn btn-outlined text-red-700">
                        Delete
                    </button>
                </form>
            </div>
                            ...
                            <form action="{{ route('step.update', $step) }}" method="post">
                                ...
                                <div class="flex items-center gap-x-3">
                                    <button
                                        type="submit"
                                        role="checkbox"
                                        class="size-5 flex items-center justify-center rounded-md text-primary-foreground {{ $step->completed ? 'bg-primary' : 'border border-primary' }}"
                                    >
                                        &check;
                                    </button>
